...
import BpmnSidebar from "@/app/(main)/components/bpmn/TasksList";
import BpmnCanvas from "@/app/(main)/components/bpmn/bpmnModeler";
import { dataItemNode } from '@/app/(main)/types/consts';
