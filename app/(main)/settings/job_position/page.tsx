...
export default function Page() {
    ...
    const [selected, setSelected] = useState<JobPosition[]>([]);
    ...
    async function fetchData() {
        ...
        const url = "https://dautv2.dadujsc.online/api/wp/object/filter/job_position"
        const body = {
            "page": 1,
            "size": 15,
            "filters": [
    ...
    const columns: Column<JobPosition>[] = [
        ...
        { key: "is_management", label: "Là quản lý" },
        { key: "use_type", label: "Kiểu sử dụng" },
